        ...
        <div className="container mx-auto max-w-6xl">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <pre className="bg-muted border border-border rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm font-mono">pip install migrator-cli</code>
                  </pre>
                </div>
                
                <div>
                  <h3 className="text-xl font-semibold mb-3">Initialize Migrator</h3>
                  <pre className="bg-muted border border-border rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm font-mono">migrator init</code>
                  </pre>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">Create a Migration</h3>
                  <pre className="bg-muted border border-border rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm font-mono">migrator makemigrations "description of changes"</code>
                  </pre>
                  <p className="text-muted-foreground mt-2">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">Apply Migrations</h3>
                  <pre className="bg-muted border border-border rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm font-mono">migrator migrate</code>
                  </pre>
                  <p className="text-muted-foreground mt-2">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6 bg-card border-border">
                <h3 className="text-xl font-semibold mb-3">migrator init</h3>
                <p className="text-muted-foreground mb-3">
                  Initialize Migrator in your project. Creates the migrations directory and configuration.
                </p>
                <pre className="bg-muted border border-border rounded-lg p-3 text-sm font-mono">
                  migrator init
                </pre>
              </Card>

              <Card className="p-6 bg-card border-border">
                <h3 className="text-xl font-semibold mb-3">migrator makemigrations</h3>
                <p className="text-muted-foreground mb-3">
              ...
              <Card className="p-6 bg-card border-border">
                <h3 className="text-xl font-semibold mb-3">migrator migrate</h3>
                <p className="text-muted-foreground mb-3">
              ...
              <Card className="p-6 bg-card border-border">
                <h3 className="text-xl font-semibold mb-3">migrator history</h3>
                <p className="text-muted-foreground mb-3">
              ...
              <Card className="p-6 bg-card border-border">
                <h3 className="text-xl font-semibold mb-3">migrator downgrade</h3>
                <p className="text-muted-foreground mb-3">
              ...
              <Card className="p-6 bg-card border-border">
                <h3 className="text-xl font-semibold mb-3">migrator current</h3>
                <p className="text-muted-foreground mb-3">
          ...
          >
            ...
            <Card className="p-8 bg-card border-border">
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-3">Database URL</h3>
                  <p className="text-muted-foreground mb-3">
                    Set your database connection URL as an environment variable:
                  </p>
                  <pre className="bg-muted border border-border rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm font-mono">export DATABASE_URL="postgresql://user:password@localhost/dbname"</code>
                  </pre>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-3">FastAPI Integration</h3>
                  <p className="text-muted-foreground mb-3">
                    Import your models in your FastAPI application:
                  </p>
                  <pre className="bg-muted border border-border rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm font-mono">{`from sqlalchemy import create_engine
...
SessionLocal = sessionmaker(bind=engine)`}</code>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">Flask Integration</h3>
                  <p className="text-muted-foreground mb-3">
                    Configure Flask-SQLAlchemy with your models:
                  </p>
                  <pre className="bg-muted border border-border rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm font-mono">{`from flask import Flask
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="p-6 bg-card border-border">
                ...
                <h3 className="text-xl font-semibold mb-3">Descriptive Names</h3>
                <p className="text-muted-foreground">
              ...
              <Card className="p-6 bg-card border-border">
                ...
                <h3 className="text-xl font-semibold mb-3">Test First</h3>
                <p className="text-muted-foreground">
              ...
              <Card className="p-6 bg-card border-border">
                ...
                <h3 className="text-xl font-semibold mb-3">Small Increments</h3>
                <p className="text-muted-foreground">
